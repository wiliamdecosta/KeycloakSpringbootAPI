...
import com.kcsb.controller.UserController;
import com.kcsb.requests.CreateUserRequest;
import com.kcsb.requests.LoginRequest;
import com.kcsb.requests.LogoutRequest;
import com.kcsb.service.KeycloakAdminClientService;
...
public class UserController {
    ...
    public ResponseEntity<?> logout(@RequestBody LogoutRequest request) {
		try {
			JsonNode node = kcProvider.signOut(request.getRefreshToken());
